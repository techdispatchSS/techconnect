...
import silver.solutions.techconnect.dto.request.admin.CreateUserRequest;
import silver.solutions.techconnect.dto.request.admin.UpdateUserRequest;
import silver.solutions.techconnect.dto.response.admin.CreateUserResponse;
import silver.solutions.techconnect.dto.response.admin.InviteResponse;
...
import silver.solutions.techconnect.mapper.AddressMapper;
import silver.solutions.techconnect.mapper.UserMapper;
...
import silver.solutions.techconnect.repository.UserSpecifications;
import silver.solutions.techconnect.util.ChangeTracker;
import silver.solutions.techconnect.util.Strings;
...
public class AdminUserService {
    ...
    public AdminUserService(
            ...
            TechConnectProperties properties,
    ...
    public PageResponse<UserResponse> list(
        ...
        return PageResponse.of(page, user ->
                userMapper.toUserResponse(user, technicianStatuses.get(user.getId())));
    }
    ...
    public CreateUserResponse create(UUID actorId, CreateUserRequest request) {
        ...
        return new CreateUserResponse(
                userMapper.toUserResponse(user, technicianStatusOf(user)), activationUrl);
    }
