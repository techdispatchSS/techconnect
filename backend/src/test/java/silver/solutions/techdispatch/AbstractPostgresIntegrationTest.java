...
public abstract class AbstractPostgresIntegrationTest {
    ...
    static final PostgreSQLContainer<?> POSTGRES =
            new PostgreSQLContainer<>("postgres:16-alpine")
                    .withDatabaseName("techdispatch")
                    .withUsername("techdispatch")
                    .withPassword("techdispatch");
    ...
    static void properties(DynamicPropertyRegistry registry) {
        ...
        registry.add("techdispatch.jwt.secret",
                () -> "integration-test-signing-secret-at-least-32-bytes");
        registry.add("techdispatch.app-base-url", () -> "http://localhost:4200");
        // Disabled so each test creates its own manager and the tests stay independent.
        registry.add("techdispatch.bootstrap-admin.email", () -> "");
    }
}
